...
const { getTodayCandles, getPrevDayCandles } = require(path.join(process.cwd(), 'dist/src/market.js'));
const { findBhavEntry } = require(path.join(process.cwd(), 'dist/src/bhav_strategy.js'));
