...
const records = JSON.parse(fs.readFileSync(path.join(process.cwd(), 'paper-records.json')));
...
const bt = JSON.parse(fs.readFileSync(path.join(process.cwd(), '5year-backtest-result.json')));
const btByDay = {};
