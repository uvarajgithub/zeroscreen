...
exports.config = exports.STRATEGY_PRESETS = exports.defaultConfig = void 0;
    ...
    try {
        ...
        if (fs_1.default.existsSync(path)) {
            ...
            if (filtered.activeStrategy === "ITM_HOLD" && !filtered.itmHold) {
                ...
                filtered.itmHold = exports.STRATEGY_PRESETS["ITM_HOLD"].itmHold;
            }
            if (filtered.activeStrategy === "BODY_BREAKOUT" && !filtered.optionSelection) {
                filtered.optionSelection = exports.STRATEGY_PRESETS["BODY_BREAKOUT"].optionSelection;
            }
            if (filtered.activeStrategy === "RC_CONFIRM" && !filtered.optionSelection) {
                filtered.optionSelection = exports.STRATEGY_PRESETS["RC_CONFIRM"].optionSelection;
            }
            if (filtered.activeStrategy === "HYBRID_REVERSE" && !filtered.risk) {
                filtered.risk = exports.STRATEGY_PRESETS["HYBRID_REVERSE"].risk;
                filtered.tradeManagement = exports.STRATEGY_PRESETS["HYBRID_REVERSE"].tradeManagement;
                filtered.optionSelection = exports.STRATEGY_PRESETS["HYBRID_REVERSE"].optionSelection;
            }
            if (filtered.activeStrategy === "AMINA" && !filtered.risk) {
                filtered.risk = exports.STRATEGY_PRESETS["AMINA"].risk;
                filtered.tradeManagement = exports.STRATEGY_PRESETS["AMINA"].tradeManagement;
                filtered.optionSelection = exports.STRATEGY_PRESETS["AMINA"].optionSelection;
            }
            return filtered;
        }
    }
